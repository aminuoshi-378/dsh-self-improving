/**
 * Standalone tsdown config for the dsh-self-improving-gui bundle.
 *
 * Produces the two artifacts dsh expects from a client plugin package:
 *   - lib/index.js    — host loader entry (the `dsh-self-improving-gui` row's apply)
...
const ID = 'dsh-self-improving-gui'
