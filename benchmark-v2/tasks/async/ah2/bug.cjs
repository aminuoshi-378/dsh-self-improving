...
// retries + 1. Between attempts it awaits baseMs * 2^(attempt-1). Success
// resolves with the value and stops; exhausting attempts rejects with the
// LAST error.

async function retryWithBackoff(fn, opts = {}) {
  // BUGGY: sync throws escape the retry loop.
