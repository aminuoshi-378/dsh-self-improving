...
eqHash(JSON.stringify(buildForm({'type':'object','properties':{'id':{'type':'number'},'opt':{'type':'string','nullable':true,'default':null}}}, {'id':'-42'})), '1c11e4c45121288e1c2901b10a53cb2c0f8c0d4064a830e21f026a1522e91cb9', 'buildForm value and errors')
...
eqHash(JSON.stringify(validate({'id':'-42'}, {'type':'object','properties':{'id':{'type':'number'},'opt':{'type':'string','nullable':true,'default':null}}})), 'd3489be09bc48e4d19ce9fa55d99d146b3c393bc3196b62fd70fbfcfaa3b9a55', 'validate on raw data')
