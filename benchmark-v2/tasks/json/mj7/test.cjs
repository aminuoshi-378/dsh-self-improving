...
eqHash(JSON.stringify(buildForm({'type':'object','properties':{'n':{'type':'number'},'flag':{'type':'boolean','default':false}}}, {'n':'3.5','flag':'TRUE'})), 'a86bb5e3a0c9a6ad48ad6ffa0fe241c54956b1cb3dbc61c1263a4d523d3a2de4', 'buildForm value and errors')
...
eqHash(JSON.stringify(validate({'n':'3.5','flag':'TRUE'}, {'type':'object','properties':{'n':{'type':'number'},'flag':{'type':'boolean','default':false}}})), '9a10e2d994af49f4c6dafd7fbff3a6362a488dc2737e07a84b034576de3c25d3', 'validate on raw data')
