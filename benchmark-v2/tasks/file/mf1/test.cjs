...
eqHash(JSON.stringify({ deds, raw: fs.readFile('raw.txt') }), 'bba64e2c7f686e3ad529307a9f843fbb5c9b9baedce9a1cf5ad908b4e38da235', 'trailing-window dedup')
const fs2 = new MemFS()
...
for (const l of ['r1','r2','r3','r4','r5','r1','r6','r7','r8']) {
  logResults.push([l, appendLog(fs3, 'svc', { maxLines: 3, keep: 2, window: 4 }, l)])
}
