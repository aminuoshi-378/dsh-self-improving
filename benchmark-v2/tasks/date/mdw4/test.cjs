...
const RULE = {'kind':'MONTHLY','step':2}
const FROM = '2023-11-30'
eqHash(JSON.stringify(nextOccurrences(RULE, FROM, 4)), 'b2181be370812512913e54483d4129a55981da9648827afc8b8cb70c4076ff05', 'recurrence expands in order')
eqHash(JSON.stringify(expand(RULE, FROM, 4)), 'b2181be370812512913e54483d4129a55981da9648827afc8b8cb70c4076ff05', 'calendar expansion is sorted and exact-length')
