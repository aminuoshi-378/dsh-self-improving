...
const RULE = {'kind':'MONTHLY','step':1}
const FROM = '2024-01-31'
eqHash(JSON.stringify(nextOccurrences(RULE, FROM, 4)), 'dba3bde09b0c938c7fe0b0c2c74e92b761f7b021d13b29b761c40a449b6c651d', 'recurrence expands in order')
eqHash(JSON.stringify(expand(RULE, FROM, 4)), 'dba3bde09b0c938c7fe0b0c2c74e92b761f7b021d13b29b761c40a449b6c651d', 'calendar expansion is sorted and exact-length')
