...
const RULE = {'kind':'WEEKLY','step':1}
const FROM = '2024-01-05'
eqHash(JSON.stringify(nextOccurrences(RULE, FROM, 4)), '43ba00831ab487dc386ac7518e7390fd5f3ec244180c20aaecb1d0e473e782d8', 'recurrence expands in order')
eqHash(JSON.stringify(expand(RULE, FROM, 4)), '43ba00831ab487dc386ac7518e7390fd5f3ec244180c20aaecb1d0e473e782d8', 'calendar expansion is sorted and exact-length')
